    ...
    "review": [
      {
        ...
        "reviewBody": "Excellent CFL customs clearance service at Heathrow. Fast, efficient, and cost-effective."
      },
      {
        "@type": "Review",
        "author": {
        ...
        "reviewBody": "Outstanding HS code classification and duty optimization. Saved us significant costs on import duties."
      }
    ]
  }
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, our expert HS code classification service helps identify the most accurate and cost-effective classification for your goods, potentially reducing import duties and taxes wherever legally possible."
        }
      },
      {
        "@type": "Question",
